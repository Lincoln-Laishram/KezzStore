...
export const Footer = () => {
    return (
        <>
            <footer className="h-[400px] p-6 text-center bg-black md:h-[520px] md:flex md:items-center md:justify-evenly  lg:h-[520px] lg:flex lg:items-center lg:justify-center lg:gap-12">
                <div>
