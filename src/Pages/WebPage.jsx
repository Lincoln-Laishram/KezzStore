            ...
            {loading ? (
                ...
                <>
                    <a
                        ...
                        className="fixed bottom-34 right-6 bg-green-600 text-white p-4 rounded-full shadow-lg hover:bg-green-500 transition-all duration-300 z-50"
                    >
                    ...
                    <div className="h-60 flex items-center justify-center w-full scale-80 gap-4 
                        md:w-80 md:mx-[14%] lg:w-100 lg:mx-[14%] lg:gap-4">
                        <Link to="/smallPack">
